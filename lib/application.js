...
Application.prototype.stop = function () {
  ...
  self.chromeDriver.process.removeListener('exit', self.onChromeDriverExit)
...
Application.prototype.startChromeDriver = function () {
  ...
  return this.chromeDriver.start().then(() => {
    self.onChromeDriverExit = function () {
      self.stop().catch(err => console.error(err))
    }
    self.chromeDriver.process.on('exit', self.onChromeDriverExit)
  })
}
